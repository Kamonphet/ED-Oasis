      ...
      <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="h-16 w-auto flex lg:flex-row md:flex-col-reverse items-center flex-wrap">
          ...
          <div class="flex ">
            <!-- เชื่อมโยงหน้า -->
            <div class="mx-3">
              <a href="../sub-index/form-pan.php" class="text-black-100 hover:text-blue-600"> <b>สร้างแผนการสอน</b> </a>
            </div>
            <div class="mx-3">
              <a href="#" class="text-red-400 hover:text-red-600"><b>สั่งซื้อแผนการสอน</b> </a>
            </div>
            <div class="mx-3">
              <a href="#" class="text-black-100 hover:text-blue-600"> <b>ประเมินแผนการสอน</b></a>
            </div>
          </div>
          <!-- Items1,2 -->
          <!-- Logo -->
                  ...
                  <form action="#"  method="GET">
                      <div class="flex">
                          ...
                          <div class="relative w-full">
                              ...
                              <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="ค้นหาแผนการสอน" required>
                          </div>
                          <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-gray-500 rounded-lg border border-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
...
<!-- 
              <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-4 sm:pr-0">
                  <h3 id="time_span" class="text-black">Time</h3>
              </div> -->
              ...
              <div class="flex items-center md:order-2 ml-3 ">
                  ...
                  <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center justify-center p-2 text-sm  rounded  bg-white-100 ">
                      <img class="h-8 w-8 mx-2 rounded-full" src="https://plus.unsplash.com/premium_photo-1671070290395-d53c20ba6ff0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=736&q=80" alt="">
