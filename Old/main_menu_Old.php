...
<body>
    ...
    <div class="grid justify-items-end">
        ...
        <div class="container m-6">
            <div>
                <p class='text-start'>หมวดหมู่ยอดนิยม</p>
                <p class="text-end"><a href="../sub-index/all-post.php">ดูทั้งหมด</a></p>
            </div>
            ...
            <div class="columns-3 w-full">
                <a href="#" class="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    ...
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">แผนการสอนจ้า</h5>
        ...
        <div class="container m-6">
            <p class='text-start'>แผนการสอนที่มีคะแนนมากที่สุด</p>
            <p class="text-end"><a href="../sub-index/all-post.php">ดูทั้งหมด</a></p>
            <div class="columns-3 w-full">
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="rounded-t-lg w-full" src="../img/logo.png" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
        ...
        <div class="bg-gray-50">
            <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
                ...
                <span class="block">เริ่มการสร้างแผนของคุณ</span>
                <span class="block text-indigo-600">Start your free trial today.</span>
                </h2>
                <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                <div class="inline-flex rounded-md shadow">
                    <a href="../sub-index/form-pan.php" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-5 py-3 text-base font-medium text-white hover:bg-indigo-700">เพิ่มแผนการสอน</a>
                </div>
    ...
    <footer>
        <?php require $_SERVER['DOCUMENT_ROOT'] . "/CED312/Index/footer.php"; ?>
    </footer>
