...
<body>
    ...
    <div class="bg-blue-100">
        <main class="h-full p-8 container mx-auto">
        <div class="grid grid-cols-2">
            ...
            <div class="grid justify-items-end">
                <div class="">
                    <a href="../Index/main_menu.php" class="text-gray-500 hover:text-blue-500">
                    ...
                    foreach ($post as $post) {
                        ...
                        echo "
                            ...
                            <div class='max-w-sm bg-white border border-gray-200 rounded-lg shadow-md'>
                                ...
                                <div class='p-5'>
                                    <h5 class='mb-2 text-2xl font-bold tracking-tight text-gray-900 truncate'>โพสต์ที่ {$post['post_id']} {$post['name']}</h5>
                                    <div class='mb-3 font-normal text-gray-700'>
                                        ...
                                        <div class='flex items-center ml-3 mb-3'>
                                            ...
                                            <p class='ml-2 text-sm font-bold text-gray-900'>{$pramern['average_score']}</p>
                                            <span class='w-1 h-1 mx-1.5 bg-gray-500 rounded-full '></span>
                                            <a href='#' class='text-sm font-medium text-gray-900 underline hover:no-underline '>{$pramern['commentt']} reviews</a>
                                        </div>
                                    </div>
                                    <div class='grid grid-cols-2'>
                                        <div>
